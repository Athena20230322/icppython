...
USERCODE_FILE = r"C:\icppython\usercodeop.txt"
...
class CertificateApiClient:
    ...
    def login_process(self):
        ...
        user_code = self._read_config(USERCODE_FILE, "randyjan003")
    ...
    def run_specified_requests(self):
        ...
        # M0132 - 已依照要求更新
        print("\n=== 執行: M0132_ChangeMemberPointSwitch ===")
        m0132_payload = {"ChangeOpPointSwitch": True, "Timestamp": get_ts()}
