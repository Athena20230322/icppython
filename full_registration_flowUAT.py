...
LAST_PHONE_FILE = os.path.join(BASE_PATH, "last_phoneuat.txt")
LAST_IDNO_FILE = os.path.join(BASE_PATH, "last_idnouat.txt")
TOKEN_FILE = os.path.join(BASE_PATH, "reglogintokeniduat.txt")
AUTH_CODE_FILE = os.path.join(BASE_PATH, "regauthcodeuat.txt")
REGISTRATION_LOG_FILE = os.path.join(BASE_PATH, "registration_loguat.txt")
...
def get_next_phone_number(start_number=950001600):
