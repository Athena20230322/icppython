...
# --- 檔案路徑設定 ---
postData_file = "C:\\icppython\\OpostData\\postData91.txt"
test_data_file = "C:\\icppython\\OTestData\\ICPAPI\\P0034_CheckFiscDoubleValidation_1.txt"
...
try:
    ...
    # --- API 請求設定 ---
    url = 'https://icp-payment-stage.icashpay.com.tw/app/TransferAccount/CheckFiscDoubleValidation'
    headers = {
