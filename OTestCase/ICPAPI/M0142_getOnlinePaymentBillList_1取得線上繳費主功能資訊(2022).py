...
# --- 檔案路徑設定 ---
# 已更新為您提供的 postData68.txt
postData_file = "C:\\icppython\\OpostData\\postData68.txt"
test_data_file = "C:\\icppython\\OTestData\\ICPAPI\\M0142_getOnlinePaymentBillList_1.txt"
...
try:
    ...
    url = 'https://icp-plus-stage.icashpay.com.tw/app/OnlinePayment/getOnlinePaymentBillList'
    headers = {
