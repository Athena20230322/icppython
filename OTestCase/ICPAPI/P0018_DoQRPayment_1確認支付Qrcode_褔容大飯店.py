...
# --- 檔案路徑設定 ---
postData_file = "C:\\icppython\\OpostData\\postData90.txt"
test_data_file = "C:\\icppython\\OTestData\\ICPAPI\\P0018_DoQRPayment_1.txt"
...
try:
    ...
    # --- API 請求設定 ---
    url = 'https://icp-payment-stage.icashpay.com.tw/app/Payment/DoQRPayment'
    headers = {
