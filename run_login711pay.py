...
def main():
    ...
    pre_scripts = ['C:\\icppython\\M0001_1.py', 'C:\\icppython\\M0007_2.py', 'C:\\icppython\\M0005_3_711pay.py']
    api_scripts = [
        'C:\\icppython\\OTestCase\\ICPAPI\\P0002_GetMemberPaymentInfo_1取得會員全付款方式.py',
        'C:\\icppython\\OTestCase\\ICPAPI\\P0001_CreateBarCode_1產生付款碼.py'
    ]
