...
class CertificateApiClient:
    ...
    def login_and_generate_requests(self):
        ...
        requests_to_generate = [
            ...
            ("GetEInvoiceCarrierInfo", {"Timestamp": ts()}, "postData4.txt"),
            ("QueryMMember", {"Timestamp": ts()}, "postData5.txt"),
            ("GetRangeNotifyMessageList", {"Timestamp": ts(), "MsgID": "0", "Type": "1", "Count": "100"},
             "postData6.txt"),
            ("GetAutoTopUpInfo", {"Timestamp": ts()}, "postData7.txt"),
            ("GetListChannelInfo", {"Timestamp": ts()}, "postData8.txt"),
            ("QueryMemberOpPoint", {"Timestamp": ts()}, "postData9.txt"),
            ("CreateTrafficQRCode", {"Timestamp": ts(), "PayID": "11682311000002951", "PaymentType": "1"},
             "postData10.txt"),
            ("QueryMemberPointSwitch", {"Timestamp": ts()}, "postData11.txt"),
            ("Payment/CreateBarcode", {"Timestamp": ts(), "PayID": "11682311000002951", "PaymentType": "1"},
             "postData12.txt"),
           ...
           # ("AuthCellPhoneCarrier", {"Timestamp": ts(), "CarrierNumber": "/AAAA", "VerificationCode": "Test1234"},"postData28.txt"),
            ...
            ("GetAccountRecordList", {"Timestamp": ts(), "QueryEndTime": "2025/07/10 14:44:33", "QueryStartTime": "2022/06/08 09:44:33", "SortType": "0"},
             "postData59.txt"),
            ("ChangeMemberPointSwitch", {"Timestamp": ts(), "ChangeOpPointSwitch": "true"}, "postData60.txt"),
            ("ChangeMemberPointSwitch", {"Timestamp": ts(), "ChangeOpPointSwitch": "false"}, "postData61.txt"),
            ("GetActivityAD", {"Timestamp": ts(), "ADEndTime": "2025/06/08 09:44:33", "ADStartTime": "2021/06/08 09:44:33", "ADType": "0"},
             "postData62.txt"),
            ("getTransferReceiverInfo", {"Timestamp": ts(), "ReceivedICPMID": "123456"}, "postData63.txt"),
            ("getTransferReceiverInfo", {"Timestamp": ts(), "ReceivedICPMID": "1682011000000322"}, "postData64.txt"),
            ("getTransferReceiverInfo", {"Timestamp": ts(), "ReceivedICPMID": "1682011000000321"}, "postData65.txt"),
            ("getPaymentToolAD",{"Timestamp": ts(), "ADEndTime": "2025/06/08 09:44:33", "ADStartTime": "2021/06/08 09:44:33",
              "ADType": "0"},"postData66.txt"),
            ("GetBankDiscount", {"Timestamp": ts(), "IsAccountLink": "true"}, "postData67.txt"),
            ("getOnlinePaymentBillList", {"Timestamp": ts()}, "postData68.txt"),
            ("getOnlinePaymentBitsList", {"Timestamp": ts(), "ItemID": "001"}, "postData69.txt"),
            ("GetCommonBillList", {"Timestamp": ts(), "NotifyID": "TPP00043"}, "postData70.txt"),
            # --- START MODIFICATION ---
            ("AddCommonBill", {"Timestamp": ts(),
                               ...
                               "CommonName": "",
                               "ItemID": "TPP00046"}, "postData71.txt"),
            # --- END MODIFICATION ---
            ...
            ("TopUpByAccountLink", {"Timestamp": ts(), "AccountID": "21917", "Amount": "10", "BankCode": "050"},
             "postData89.txt"),
            ("DoQRPayment", {"Timestamp": ts(), "Amount": "5", "MerchantID": "10523880", "PayID": "11682311000002844"},
             "postData90.txt"),
